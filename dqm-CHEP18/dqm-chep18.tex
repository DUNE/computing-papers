...
\author{ 
\lastname{M Potekhin}\inst{1}\fnsep\thanks{\email{potekhin@bnl.gov}} \it{for the DUNE Collaboration}
}
...
It will include four 10kt modules utilizing single and dual-phase Liquid Argon
