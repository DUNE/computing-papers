...
of the single-phase Liquid Argon Time Projection Chamber (LArTPC) to be used the
the DUNE experiment  \cite{cdrVol1, cdrVol4}. The experiment took test beam data in
2018 and cosmic ray data throughout 2019. The nature of the experiment required a versatile
Data Quality Monitoring (DQM) system capable of performing complex calculations on
a few minutes time scale as well as preserve the results (inluding various types of graphics
