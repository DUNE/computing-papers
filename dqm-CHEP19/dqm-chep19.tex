...
(time series stored in the database and rendered graphically in the Web UI)
...
\item Self-describing DQM output data simplifying integration with the content service
