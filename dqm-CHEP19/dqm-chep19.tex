...
prompt processing system database, forming a queue. The prompt processing system
then nmatches jobs to the available pilot jobs (running asynchronously) and monitors
...
\end{itemize}
\noindent
A high-or one-column wide figures use syntax of figure~\ref{dqm-diagram}
\begin{figure}[h]

\centering
\includegraphics[width=0.9\textwidth,clip]{figures/dqm-p3s-diagram.png}
\caption{Please write your figure caption here}
\label{dqm-diagram}       % Give a unique label
\end{figure}
