...
\section{Overview of the protoDUNE program}
...
of wire sensors grouped into planar assemblies (termed Anode Plane Assemblies, or APAs).
...
and thus high channel count. The 2\,MHz digitization provides similarly fine spatial and
temporal resolution along the drift axis of the detector. The readout window is  set to 5\,ms 
based on the scale of electron drift time across the active volume.  These characteristics are typical of
