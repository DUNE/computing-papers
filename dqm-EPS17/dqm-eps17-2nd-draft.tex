...
as by displaying ADC spectra and their variations. It is characterized by a  low latency, high bandwidth and
...
(such as estimations of the Liquid Argon purity, noise reduction and correlations of channel noise etc) 
...
\noindent As an example, the workflow described in the first item above can be modeled as a Directed Acyclic Graph (DAG)
