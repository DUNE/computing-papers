...
experiment, and of the same size which is 6$\times$2.4\,m. Drift distance is 3.6\,m
...
%(dictated by high granularity and the volume of the detector),
...
from the Data Acquisition System. It is characterized by a  low latency, high bandwidth and
...
%Given the complex physics and readout of the detector, 
In order to be able to produce actionable information to the experiment operators (such as estimations of the
Liquid Argon purity, correlations of channel noise etc) the Online Monitoring needs to be complemented
with the Data Quality Monitoring (DQM) system.
...
%protoDUNE-SP will use a prompt processing system to support.
It will include a few types of calculations, such as
\begin{itemize}
